    ...
    <>
      <div className="sidebar">
        <div className="sidebar__profile">
          ...
          <div className="profile__stats">
            <span>
              Connections <br /> <b>Grow your Network</b>
            </span>
